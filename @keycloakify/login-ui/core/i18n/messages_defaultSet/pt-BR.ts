...
const messages = {
    ...
    "webauthn-error-auth-verification":
        "O resultado da autenticação com chave de segurança é inválido.<br /> {0}",
    "webauthn-error-register-verification":
        "O resultado do registro de chave de segurança é inválido.<br /> {0}",
    ...
    linkIdpActionMessage: "Você quer vincular sua conta com {0}?",
    ...
    "passkey-doAuthenticate": "Entrar com chave de segurança",
