...
const messages = {
    ...
    "saml.post-form.js-disabled":
        "JavaScript aktif değil. Aktifleştirmenizi öneririz. Devam etmek için aşağıdaki butona tıklayınız. ",
    ...
    "auth-recovery-authn-code-form-help-text":
        "Önceden oluşturulmuş listeden seçtiğiniz doğrulama kodunu giriniz.,",
    ...
    "recovery-code-config-warning-message":
        "Şifre yöneticinizi yazdırdığınızdan, indirdiğinizden veya kopyaladığınızdan emin olun. Kurulumu iptal etmek kurtarma kodlarını hesabınızdan kaldıracaktır.,",
    ...
    "recovery-codes-download-file-description":
        "Kurtarma kodları doğrulayıcınıza erişiminiz olmadığı zaman giriş yapabilmenizi sağlayan tek kullanımlık geçiş anahtarlarıdır.,",
    ...
    "webauthn-unsupported-browser-text":
        "WebAuthn tarayıcınız tarafından desteklenmemektedir. Başka bir tarayıcıdan ulaşmayı deneyin veya yöneticinizle iletişime geçin.,",
    ...
    "webauthn-error-different-user":
        "İlk doprulanan kullanıcı ile Geçiş Anahtarı işe doğrulanan kullanıcı aynı değil..,",
    ...
    finalDeletionConfirmation:
        "Hesabınızı silerseniz geri kurtarılamaz. Hesabınızı korumak için İptal'e tıklayın.,",
    ...
    "error-invalid-multivalued-size":
        "{0} özniteliği en az {1} ve en fazla {2} değer(ler)e sahip olmalıdır.,",
