...
const messages = {
    ...
    resourceNoPermissionsGrantingAccess:
        "Er zijn geen rechten verleend die toegang verlenen tot deze bron",
    ...
    havePermissionRequestsWaitingForApproval:
        "U heeft {0} toestemmingsverzoeken die wachten op goedkeuring.",
    ...
    identityProviderMessage:
        "Om uw account te koppelen aan de identiteitsproviders die u heeft ingesteld",
    ...
    authenticatorMobileMessage:
        "Gebruik mobiele authenticator om verificatiecodes te krijgen als tweefactorauthenticatie.",
    ...
    authenticatorSMSMessage:
        "Keycloak stuurt de verificatiecode naar uw telefoon als tweefactorauthenticatie.",
    ...
    smscodeIntroMessage:
        "Voer uw telefoonnummer in en er wordt een verificatiecode naar uw telefoon verzonden.",
    mobileSetupStep1:
        "Installeer een authenticator-app op uw telefoon. De hier vermelde apps worden ondersteund.",
    mobileSetupStep2: "Open de applicatie en scan de barcode:",
    mobileSetupStep3:
        "Voer de eenmalige code in die door de app wordt verstrekt en klik op Opslaan om de installatie te voltooien.",
