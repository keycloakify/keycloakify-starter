...
const messages = {
    ...
    applicationsIntroMessage:
        "Отслеживайте и управляйте разрешениями приложений на доступ к вашей учетной записи",
    ...
    readOnlyUsernameMessage:
        "Вы не можете обновить имя пользователя вашей учетной записи, т.к. оно доступно только для чтения.",
