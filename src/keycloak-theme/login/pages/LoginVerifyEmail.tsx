    ...
    return (
        <Template {...{ kcContext, i18n, doUseDefaultCss, classes }} displayMessage={false} headerNode={
            <HeaderNode
                ...
                subtitle={`An email with instructions to verify your email address has been sent to your address${user?.email ? ` ${user.email}` : ""}.`}
                asset={<div className="flex justify-center">
