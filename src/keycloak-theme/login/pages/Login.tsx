    ...
    return (
        <Template
            ...
            infoNode={
                ...
                realm.registrationAllowed &&
                !registrationDisabled && (
                    <Button onClick={() => window.location.href = url.registrationUrl} className={"h-11 w-full m-0 text-bold"} size="md" colorScheme="gray" >
                ...
                {realm.password && (<form id="kc-form-login" onSubmit={(e) => { e.preventDefault(); e.stopPropagation(); onSubmit(e) }} action={url.loginAction} method="post" noValidate ref={ref} className="space-y-4 mt-10">
                    ...
                    <VStack alignItems="start" spacing={1}>
                        {realm.rememberMe && !usernameHidden && (
                            ...
                            }} checked={rememberMe} colorScheme="gray"><Text fontSize="small">Remember Me</Text></Checkbox>
                        )}
