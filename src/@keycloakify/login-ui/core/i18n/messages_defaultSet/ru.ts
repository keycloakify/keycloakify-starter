...
const messages = {
    ...
    "auth-recovery-authn-code-form-help-text":
        "Введите код аутентификации восстановления из ранее сгенерированного списка.",
    ...
    "webauthn-error-different-user":
        "Первый аутентифицированный пользователь — это не тот, который аутентифицирован с помощью ключа доступа.",
    "webauthn-error-auth-verification":
        "Результат аутентификации ключа доступа недействителен.<br /> {0}",
    "webauthn-error-register-verification":
        "Результат регистрации ключа доступа недействителен.<br /> {0}",
