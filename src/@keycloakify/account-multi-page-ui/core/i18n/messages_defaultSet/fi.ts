...
const messages = {
    ...
    federatedIdentityRemovingLastProviderMessage:
        "Et voi poistaa viimeistä yhdistettyä henkilöllisyyttä, koska sinulla ei ole salasanaa.",
    ...
    removeAccessMessage:
        "Sinun täytyy myöntää käyttöoikeus uudelleen, jos haluat käyttää tätä sovellustiliä.",
    ...
    authenticatorMobileMessage:
        "Käytä mobiili-todentajaa saadaksesi vahvistuskoodit kaksivaiheiseen tunnistautumiseen",
    ...
    authenticatorSMSMessage:
        "Keycloak lähettää sinulle vahvistuskoodit kaksivaiheista tunnistautumista varten.",
    ...
    authenticatorBackupCodesFinishSetUpMessage:
        "12 varmuuskoodia luotiin tällä kertaa. Jokaisen niistä voi käyttää yhden kerran.",
    ...
    mobileSetupStep3:
        "Syötä saamasi kertaluontoinen koodi allaolevaan kenttään ja paina Tallenna viimeistelläksesi asetuksen.",
