...
const messages = {
    ...
    federatedIdentityRemovingLastProviderMessage:
        "لا يمكنك إزالة آخر هوية متحدة لأنه ليس لديك كلمة مرور.",
    ...
    authenticatorFinishSetUpMessage:
        "في كل مرة تقوم فيها بتسجيل الدخول إلى حسابك، سيطلب منك تقديم رمز مصادقة ثنائي.",
    authenticatorSubTitle: "إعداد المصادقة الثنائية",
    authenticatorSubMessage:
        "لتعزيز أمان حسابك، قم بتمكين طريقة واحدة على الأقل من طرق المصادقة الثنائية المتاحة.",
