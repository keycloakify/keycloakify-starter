    ...
    return (
        ...
        >
            <>
                    ...
                    {kcContext.mode == "manual" ? (
                        <>
                            <li>
                                ...
                                <p>
                                    <span id="kc-totp-secret-key">{kcContext.totp.totpSecretEncoded}</span>
                                </p>
                                <p>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li id="kc-totp-type">
                                        {msg("loginTotpType")}: {msg(`loginTotp.${kcContext.totp.policy.type}`)}
                                    </li>
                                    <li id="kc-totp-algorithm">
                                        {msg("loginTotpAlgorithm")}: {kcContext.totp.policy.getAlgorithmKey()}
                                    </li>
                                    ...
                                    {kcContext.totp.policy.type === "totp" ? (
                                        ...
                                        <li id="kc-totp-counter">
                                            {msg("loginTotpCounter")}: {kcContext.totp.policy.initialCounter}
                                        </li>
                                    )}
                                </ul>
                            </li>
                        ...
                        <li>
                            ...
                            <img id="kc-totp-secret-qr-code" src={`data:image/png;base64, ${kcContext.totp.totpSecretQrCode}`} alt="Figure: Barcode" />
                            <br />
                            <p>
                ...
                <form action={kcContext.url.loginAction} className={kcClsx("kcFormClass")} id="kc-totp-settings-form" method="post">
