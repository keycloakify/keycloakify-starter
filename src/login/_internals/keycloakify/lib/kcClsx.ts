...
import { type CxArg, clsx_withTransform } from "keycloakify/tools/clsx_withTransform";
...
export function createGetKcClsx<ClassKey extends string>(params: {
    ...
    function getKcClsx(params: {
    ...
    }): { kcClsx: { (...args: CxArg<ClassKey>[]): string; doUseDefaultCss: boolean; } } {
        ...
        kcClsx.doUseDefaultCss = doUseDefaultCss;
