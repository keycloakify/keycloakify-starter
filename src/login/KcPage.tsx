                    ...
                    {(() => {
                        switch (kcContext.pageId) {
                            ...
                            case "login-verify-email.ftl":
                                return (
                                    <LoginVerifyEmail kcContext={kcContext} {...rest} />
                                );
                            case "terms.ftl":
                            ...
                            case "login-oauth-grant.ftl":
                                return (
                                    <LoginOauthGrant kcContext={kcContext} {...rest} />
                                );
                            case "login-otp.ftl":
                            ...
                            case "webauthn-register.ftl":
                                return (
                                    <WebauthnRegister kcContext={kcContext} {...rest} />
                                );
                            ...
                            case "login-idp-link-email.ftl":
                                return (
                                    <LoginIdpLinkEmail kcContext={kcContext} {...rest} />
                                );
                            case "login-page-expired.ftl":
                                return (
                                    <LoginPageExpired kcContext={kcContext} {...rest} />
                                );
                            case "login-config-totp.ftl":
                                return (
                                    <LoginConfigTotp kcContext={kcContext} {...rest} />
                                );
                            ...
                            case "delete-credential.ftl":
                                return (
                                    <DeleteCredential kcContext={kcContext} {...rest} />
                                );
                            case "code.ftl":
                            ...
                            case "frontchannel-logout.ftl":
                                return (
                                    <FrontchannelLogout kcContext={kcContext} {...rest} />
                                );
